...
#ifndef NS3_MPI
namespace ns3 { struct MpiInterfaceStub {
  static void Enable(int*, char***) { throw std::runtime_error("This build has no MPI support (distributed mode unavailable)"); }
  static uint32_t GetSystemId() { return 0; }
  static uint32_t GetSize() { return 1; }
  static void Disable() {}
  static bool IsEnabled() { return false; }
}; }
#define MpiInterface MpiInterfaceStub
#endif
...
PointToPointLaserHelper::PointToPointLaserHelper ()
{
  ...
  // (remote channel removed in the ns-3.48 port: no MPI)
}
