...
ArbiterResult Arbiter::BaseDecide(Ptr<const Packet> pkt, Ipv4Header const &ipHeader) {
    ...
    // [ns-3.48 port] newer ns-3 default-constructs Ipv4Address as 0.0.0.0 instead of 102.102.102.102
    bool is_socket_request_for_source_ip = source_ip == 1717986918 || source_ip == 0;
