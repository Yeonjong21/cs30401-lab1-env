...
namespace ns3 {
    ...
    Ipv4ArbiterRouting::RouteOutput(Ptr <Packet> p, const Ipv4Header &header, Ptr <NetDevice> oif, Socket::SocketErrno &sockerr) {
        ...
        // [ns-3.48 port] Newer ns-3 may query a route for the unspecified address (0.0.0.0),
        // e.g., for an unconnected socket. No node owns it, so report "no route" instead of throwing.
