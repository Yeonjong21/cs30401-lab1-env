...
private:
  // (ns-3.48 added MobilityModel::Copy(); defined here without "override" so it also compiles on older ns-3)
  Ptr<MobilityModel> Copy () const { NS_FATAL_ERROR ("Copy() is not supported by SatellitePositionMobilityModel"); return nullptr; }
